              ...
              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-lg">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $no = 0;
                    $query = mysqli_query($koneksi,"SELECT tb_siswa.id,tb_siswa.nama,tb_siswa.nisn,tb_siswa.tanggal_lahir,tb_sekolah.nama_sekolah, tb_siswa.nilai, tb_siswa.lulus_tidak FROM tb_siswa LEFT JOIN tb_sekolah ON tb_siswa.id_sekolah = tb_sekolah.id_sekolah");
            ...
            <div class="modal-body">
              ...
              <div class="form-row">
                <div class="col-12 mb-3">
                  <label for="" class="form-label">Nama Lengkap Siswa</label>
